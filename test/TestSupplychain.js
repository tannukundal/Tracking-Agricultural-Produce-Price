...
contract('SupplyChain', function (accounts) {
    ...
    const originFarmName = "Ravi Kishan";
    const originFarmInformation = "Nilgiri Hills";
    const originFarmLatitude = "38.239770";
    const originFarmLongitude = "44.341490";
    var productID = sku + upc;
    const productNotes = "Best beans with high quality";
    ...
    // 1st Test
    it("Testing smart contract function harvestItem() that allows a farmer to harvest", async () => {
